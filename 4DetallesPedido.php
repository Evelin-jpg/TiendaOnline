...
<body>
  <div class="container">
    <div class="detalles-container">
      <div class="detalles-card">
        ...
        if (isset($_GET['id'])) {
          // Obtener el ID del pedido de la URL y asegurarse de que sea un número entero
          ...
          if ($result->num_rows > 0) {
            ...
            echo "<p class='text-center'>No se encontraron detalles para este pedido.</p>";
          }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a id="deleteDetailLink" href="#" class="btn btn-danger">Eliminar</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    confirmModal.addEventListener('show.bs.modal', function (event) {
      ...
      var deleteDetailLink = document.getElementById('deleteDetailLink');
      deleteDetailLink.href = '4EliminarDetallesPedidosPHP.php?id_detalles=' + idDetalle + '&id_pedido=<?php echo $id_pedido; ?>';
    });
  </script>
